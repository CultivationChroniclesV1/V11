...
export const gameStateSchema = z.object({
  ...
  martialArts: z.record(z.object({
    ...
    effect: z.object({
      type: z.enum(["lifesteal", "poison", "defense", "health", "crit", "dodge"]),
      value: z.number(),
  ...
  qiStones: z.number().default(10), // Changed from spiritualStones to qiStones
